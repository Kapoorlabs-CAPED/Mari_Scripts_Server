...
def main( config : OneatConfig):
        ...
        save_json(dynamic_cord_json, model_dir + config.files_oneat.lstm_cord_json + '.json')        




        MovieCreator.MovieLabelDataSet(train_image_dir, 
                                    train_seg_image_dir, 
                                    train_csv_dir, 
                                    train_save_dir, 
                                    event_type_name, 
        ...
        MovieCreator.createNPZ(train_save_dir, axes = 'STXYC', save_name = npz_name, save_name_val = npz_val_name, train_size = 0.99)
