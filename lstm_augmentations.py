...
from oneat_augmentations import AugmentTYXCsv
import os
                    ...
                    if name == Segname:
                                ...
                                for i in  range(0, len(event_type_name)):
                                    ...
                                    if classfound:
                                        ...
                                        for rotate_angle in rotation_angles:
                                                ...
                                                rotate_pixels = AugmentTYXCsv(rotate_angle = rotate_angle)
                        ...
                        for csvfname in files_csv:
                                ...
                                for i in  range(0, len(event_type_name)):
                                    ...
                                    if classfound: 
                                        #Additive Noise
                                        addnoise_pixels = AugmentTYXCsv(mean = mean, sigma = sigma, distribution = distribution)
