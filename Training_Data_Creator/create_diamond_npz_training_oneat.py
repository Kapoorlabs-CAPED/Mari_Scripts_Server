...
image_dir = '/mnt/jean_zay_backup/Mari_Data_Training/oneat_training/ovh_diamond_raw_aug/'
#Specify the directory contaiing csv files
csv_dir = '/mnt/jean_zay_backup/Mari_Data_Training/oneat_training/ovh_diamond_csv_aug/'
#Specify the directory containing the segmentations
seg_image_dir = '/mnt/jean_zay_backup/Mari_Data_Training/oneat_training/ovh_diamond_seg_aug/'
#Specify the model directory where we store the json of categories, training model and parameters
model_dir = '/mnt/WorkHorse/Mari_Models/Oneat/'
#Directory for storing center ONEAT training data 
save_dir = '/mnt/jean_zay_backup/Mari_Data_Training/oneat_training/oneat_train_diamond_patches_m1p1/'
